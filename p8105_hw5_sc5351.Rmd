...
we can find that as the true mean increases, power also increases. After the true mean of 4, power is infinitely close to 1.
...
The green line shows the average estimate across all tests, and the red line shows the average estimate when the null hypothesis is rejected. When true mean is smaller than 4, the sample average of μ̂ across tests for which the null is rejected are different from the true means, because the effects size and power are small. When true mean is bigger than 4, the sample average of μ̂ across tests for which the null is rejected are the same as the true means, because the effects size and power are bigger.